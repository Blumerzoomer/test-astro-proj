...
export default function HomeSection() {
  return (
    <div className="w-full">
      <HomeImages/>
      <div className="flex  flex-col max-w-[517px] mx-auto items-center w-full my-auto p-4  absolute z-[3] top-[78%] sm:top-[82%] left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="w-full">
